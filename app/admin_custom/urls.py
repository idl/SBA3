...
urlpatterns = [
  ...
  url(r'^add-students-bulk$', AdminViews.admin_add_students_bulk, name='admin_add_students_bulk'),
  url(r'^add-student-single$', AdminViews.admin_add_student_single, name='admin_add_student_single'),
