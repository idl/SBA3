...
TEMPLATE_DIRS = (
    os.path.join(BASE_DIR, 'sba3/templates/sba3'),
...
SECRET_KEY = 'b&!3n-*+)as$27wg#k@l+s)2^9+p^pwvbrw6mpz=duvougr6$r'
...
# --Change to POSTGRES after we decide on the database layout
DATABASES = {
    'default': {
